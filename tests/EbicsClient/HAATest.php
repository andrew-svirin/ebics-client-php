 ...
 */
class HAATest extends TestCase
{
    public function testOk(): void
    {
        ...
        $requestHandler->expects(self::once())->method('buildHAA')->with($bank, $user, $keyRing, $date)->willReturn($request);
        ...
        self::assertEquals($responseXml, $sUT->HAA($bank, $user, $keyRing, $date));
    }
}
