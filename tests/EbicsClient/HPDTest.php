 ...
 */
class HPDTest extends TestCase
{
    public function testOk(): void
    {
        ...
        $requestHandler->expects(self::once())->method('buildHPD')->with($bank, $user, $keyRing, $date)->willReturn($request);
        ...
        self::assertEquals($responseXml, $sUT->HPD($bank, $user, $keyRing, $date));
    }
}
