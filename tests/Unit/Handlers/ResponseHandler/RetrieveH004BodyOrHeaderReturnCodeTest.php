...
';
        ...
        self::assertEquals('hi!', $sUT->retrieveH004BodyOrHeaderReturnCode(new Response($xml)));
    }
...
';
        ...
        self::assertEquals('000001', $sUT->retrieveH004BodyOrHeaderReturnCode(new Response($xml)));
    }
...
';
        ...
        $sUT->retrieveH004BodyOrHeaderReturnCode(new Response($xml));
    }
}
