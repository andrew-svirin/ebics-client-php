 ...
 */
class BuildVMKTest extends TestCase
{
...
-----END PUBLIC KEY-----';
        ...
        $certificatX->expects(self::never())->method('getPrivateKey')->willReturn($rsaPrivateKey);
        ...
        $keyring->expects(self::never())->method('getUserCertificateX')->willReturn($certificatX);
...
';
        ...
        self::assertXmlStringEqualsXmlString($expected, $sUT->buildVMK($bank, $user, $keyring, $date)->getContent());
    }
}
