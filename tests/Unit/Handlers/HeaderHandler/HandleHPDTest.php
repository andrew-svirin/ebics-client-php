 ...
 */
class HandleHPDTest extends TestCase
{
    public function testEmptyBankCertificateX(): void
    {
        ...
        $sUT->handleHPD($bank, $user, $keyRing, $domDocument, $domElement, new DateTime('2010-10-10 10:10:10'));
    }
...
<test>
    <header authenticate="true">
        ...
        self::assertXmlStringEqualsXmlString($expected, $sUT->handleHPD($bank, $user, $keyRing, $domDocument, $domElement, new DateTime('2010-10-10 10:10:10')));
    }
}
