 ...
 */
class HandleVMKTest extends TestCase
{
    public function testEmptyBankCertificateX(): void
    {
        ...
        $sUT->handleVMK($bank, $user, $keyRing, $domDocument, $domElement, new DateTime('2010-10-10 10:10:10'));
    }
...
<test>
    <header authenticate="true">
        ...
        self::assertXmlStringEqualsXmlString($expected, $sUT->handleVMK($bank, $user, $keyRing, $domDocument, $domElement, new DateTime('2010-10-10 10:10:10')));
    }
}
