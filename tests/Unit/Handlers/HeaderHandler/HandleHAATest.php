 ...
 */
class HandleHAATest extends TestCase
{
    public function testEmptyBankCertificateX(): void
    {
        ...
        $sUT->handleHAA($bank, $user, $keyRing, $domDocument, $domElement, new DateTime('2010-10-10 10:10:10'));
    }
...
<test>
    <header authenticate="true">
        ...
        self::assertXmlStringEqualsXmlString($expected, $sUT->handleHAA($bank, $user, $keyRing, $domDocument, $domElement, new DateTime('2010-10-10 10:10:10')));
    }
}
