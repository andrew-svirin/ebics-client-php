 ...
 */
class HandleSTATest extends TestCase
{
    public function testEmptyBankCertificateX(): void
    {
        ...
        $sUT->handleSTA($bank, $user, $keyRing, $domDocument, $domElement, new DateTime('2010-10-10 10:10:10'));
    }
...
<test>
    <header authenticate="true">
        ...
        self::assertXmlStringEqualsXmlString($expected, $sUT->handleSTA($bank, $user, $keyRing, $domDocument, $domElement, new DateTime('2010-10-10 10:10:10')));
    }
}
