 ...
 */
class HandleFDLTest extends TestCase
{
    public function testEmptyBankCertificateX(): void
    {
        ...
        self::expectExceptionMessage('Certificate bank X is empty.');

        $sUT->handleFDL($bank, $user, $keyRing, $domDocument, $domElement, new DateTime('2010-10-10 10:10:10'), 'test', 'test');
    }
    ...
    public function testEmptyBankCertificateE(): void
    {
        ...
        self::expectException(EbicsException::class);
        self::expectExceptionMessage('Certificate bank E is empty.');
    ...
    <header authenticate="true">
        <static>
            ...
            <OrderDetails>
                ...
                <FDLOrderParams>
                  <FileFormat CountryCode="FR">myFileInfo</FileFormat>
                </FDLOrderParams>
            </OrderDetails>
           <BankPubKeyDigests>
        ...
        self::assertXmlStringEqualsXmlString($expected, $sUT->handleFDL($bank, $user, $keyRing, $domDocument, $domElement, new DateTime('2010-10-10 10:10:10'), 'myFileInfo', 'FR'));
    }
}
