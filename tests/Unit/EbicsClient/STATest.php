 ...
 */
class STATest extends TestCase
{
    public function testOk(): void
    {
        ...
        $requestHandler->expects(self::once())->method('buildSTA')->with($bank, $user, $keyRing, $date, null, null)->willReturn($request);
        ...
        self::assertEquals($responseXml, $sUT->STA($bank, $user, $keyRing, $date));
    }
}
