 ...
 */
class HKDTest extends TestCase
{
    public function testOk(): void
    {
        ...
        $requestHandler->expects(self::once())->method('buildHKD')->with($bank, $user, $keyRing, $date)->willReturn($request);
        ...
        self::assertEquals($responseXml, $sUT->HKD($bank, $user, $keyRing, $date));
    }
}
