...
namespace AndrewSvirin\Ebics\Tests\Unit\Factories\X509;
...
class X509GeneratorTest extends TestCase
{
    ...
    {
        return (string) file_get_contents(getcwd() . '/tests/Unit/_data/certificates/' . $name);
    }

    private function getPrivateKey(): string
    {
        return (string) file_get_contents(getcwd() . '/tests/Unit/_data/private_key.rsa');
    }

    private function getPublicKey(): string
    {
        return (string) file_get_contents(getcwd() . '/tests/Unit/_data/public_key.rsa');
    }
}
